 ...
 */
class AcknowledgingMessageRouter(private val kodein: Kodein, private val pipe: Pipe, private val ownID: UserID, private val neighborID: UserID, private val serviceIdWhitelist: List<ServiceId>? = null) : MessageRouter {
    ...
    override fun sendMessages() {
        ...
        val algorithmMessageList: MutableList<String> = algorithmMessageRepository.getAllMessagesAsList()
                .asSequence()
...
class AcknowledgingMessageRouterFactory : MessageRouterFactory {
    override fun create(kodein: Kodein, pipe: Pipe, ownID: UserID, neighborID: UserID, serviceIdWhitelist: List<ServiceId>?): MessageRouter {
        return AcknowledgingMessageRouter(kodein, pipe, ownID, neighborID, serviceIdWhitelist)
    }
}
