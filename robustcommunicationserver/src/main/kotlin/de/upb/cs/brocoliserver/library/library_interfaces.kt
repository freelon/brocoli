...
import de.upb.cs.brocoliserver.library.util.toBase64String
...
interface ServiceHandler {
     ...
     */
    fun registerService(serviceId: Byte, callbackHandler: ServiceCallback, serviceName: String?, serviceOnlineHandler: ServiceOnlineHandler, onlineHandlerId: UserID?)
