 ...
 */
class SimpleMessageRouter(private val kodein: Kodein, private val pipe: Pipe, private val ownID: UserID, private val neighborID: UserID) : MessageRouter {
    ...
    override fun sendMessages() {
        val messageList: MutableList<String> = algorithmMessageRepository.getAllMessages().map { it.id }.toMutableList()
...
class SimpleMessageRouterFactory : MessageRouterFactory {
    override fun create(kodein: Kodein, pipe: Pipe, ownID: UserID, neighborID: UserID): MessageRouter {
        return SimpleMessageRouter(kodein, pipe, ownID, neighborID)
    }
}
